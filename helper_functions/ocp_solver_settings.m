function [ocp_opts, settings] = ocp_solver_settings(ocp_model, model, N)
...
if exist('warm_start_first_qp', 'var')
    settings.warm_start_first_qp = warm_start_first_qp;
    ocp_opts.set('warm_start_first_qp', warm_start_first_qp);
end
